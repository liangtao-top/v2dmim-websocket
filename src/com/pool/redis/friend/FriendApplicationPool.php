...
// +----------------------------------------------------------------------
// | Version: 2.0 2021/6/7 10:28
// +----------------------------------------------------------------------

namespace com\pool\redis\friend;
...
class FriendApplicationPool
{
    ...
    static public function instance(): RedisPool
    {
        ...
        if (is_null(self::$instance)) {
            $config         = Config::instance()->redis['connections']['friend']['friend_application'];
